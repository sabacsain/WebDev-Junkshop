...
<!-- start of edit for php -->
    ...
    <form method="POST">
        <div class="input-group mb-3 search-input">
            <input type="text" class="form-control" placeholder="Search user id, username, or address" name="word">
    ...
    <div class="table-container">
        ...
        <thead >
                <tr>
                    ...
                    <th class="align-middle">DATE SENT</th>
                </tr>
            </thead>
            <tbody>
            <?php
                ...
                if(isset($_POST['search'])){
                    $word = $_POST['word'];
                    $query = "SELECT * FROM message WHERE message_id LIKE '%$word%' 
                    OR name LIKE '%$word%' OR email LIKE '%$word%'";
