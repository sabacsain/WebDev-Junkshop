  ...
  <section class="admin-dashboard">
      ...
      <div class="admin-upper">
        ...
        <div class="admin-button">    
            ...
            <button onclick="location.href='admin-user.php'" class="active">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="9" cy="6" r="3" fill="#198B72"/>
                    <path d="M3.94488 13.2521C4.42256 10.983 6.68109 9.75 9 9.75C11.3189 9.75 13.5774 10.983 14.0551 13.2521C14.1083 13.5049 14.1531 13.7637 14.1862 14.0259C14.2538 14.5611 13.8127 15 13.2732 15H4.72678C4.18732 15 3.74616 14.5611 3.8138 14.0259C3.84694 13.7637 3.89167 13.5049 3.94488 13.2521Z" fill="#198B72"/>
                </svg>
                Users
            </button>
        ...
        <thead >
            ...
            <?php
                ...
                if(isset($_POST['search'])){
                    $word = $_POST['word'];
                    $query = "SELECT * FROM user WHERE user_id LIKE '%$word%' 
                    OR username LIKE '%$word%' OR address LIKE '%$word%'";
